...
public class Product
{
    ...
    public void WriteToConsole()
    {
        ...
        // Перевантаження оператора приведення до типу string
        public static implicit operator string(Product product)
        {
            return $"Name: {product.Name}, Price: {product.Price}, Manufacturer: {product.Manufacturer}, Manufacturing Date: {product.ManufacturingDate.ToShortDateString()}";
        }
